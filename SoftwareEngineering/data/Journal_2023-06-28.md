...
23
24
25</pre></td><td><pre style="margin: 0; line-height: 125%"><span style="font-weight: bold">import</span> <span style="font-weight: bold">java.util.regex.*</span>;

<span style="font-weight: bold">public</span> <span style="font-weight: bold">class</span> <span style="font-weight: bold">Single</span> {
<span style="font-weight: bold">public</span> <span style="font-weight: bold">static</span> <span style="font-weight: bold">void</span> main(String[] args) {
	...
	var text = <span style="font-style: italic">&quot;start: 2023-06-28&quot;</span>;
	var regex = Pattern.compile(<span style="font-style: italic">&quot;(?&lt;year&gt;\\d{4})-(?&lt;month&gt;\\d{2})-(?&lt;day&gt;\\d{2})&quot;</span>);
	
	var matcher = regex.matcher(text);
	
	var found = matcher.find(); <span style="font-style: italic">// =&gt; true</span>
	System.out.println(found); <span style="font-style: italic">// =&gt; true</span>
	
	System.out.println(matcher.hasMatch()); <span style="font-style: italic">// =&gt; true</span>
	System.out.println(matcher.group()); <span style="font-style: italic">// =&gt; &quot;2023-06-28&quot;</span>
	System.out.println(matcher.group(0)); <span style="font-style: italic">// =&gt; &quot;2023-06-28&quot;</span>
	System.out.println(matcher.group(1)); <span style="font-style: italic">// =&gt; &quot;2023&quot;</span>
	System.out.println(matcher.group(2)); <span style="font-style: italic">// =&gt; &quot;06&quot;</span>
	System.out.println(matcher.group(3)); <span style="font-style: italic">// =&gt; &quot;28&quot;</span>
	System.out.println(matcher.group(<span style="font-style: italic">&quot;year&quot;</span>)); <span style="font-style: italic">// =&gt; &quot;2023&quot;</span>
	System.out.println(matcher.group(<span style="font-style: italic">&quot;month&quot;</span>)); <span style="font-style: italic">// =&gt; &quot;06&quot;</span>
	System.out.println(matcher.group(<span style="font-style: italic">&quot;day&quot;</span>)); <span style="font-style: italic">// =&gt; &quot;28&quot;</span>
...
28
29
30</pre></td><td><pre style="margin: 0; line-height: 125%"><span style="font-weight: bold">import</span> <span style="font-weight: bold">java.util.regex.*</span>;

<span style="font-weight: bold">public</span> <span style="font-weight: bold">class</span> <span style="font-weight: bold">Multiple</span> {
<span style="font-weight: bold">public</span> <span style="font-weight: bold">static</span> <span style="font-weight: bold">void</span> main(String[] args) {

	var text = <span style="font-style: italic">&quot;I read \&quot;Termination Shock\&quot; between 2022-02-20 and 2022-07-16.&quot;</span>;
	var regex = Pattern.compile(<span style="font-style: italic">&quot;(\\d{4})-(\\d{2})-(\\d{2})&quot;</span>);

	var matcher = regex.matcher(text);

	<span style="font-weight: bold">while</span> (matcher.find()) {
	    System.out.println(<span style="font-style: italic">&quot;full: &quot;</span> + matcher.group());
	    System.out.println(<span style="font-style: italic">&quot;year: &quot;</span> + matcher.group(1));
	    System.out.println(<span style="font-style: italic">&quot;month: &quot;</span> + matcher.group(2));
	    System.out.println(<span style="font-style: italic">&quot;day: &quot;</span> + matcher.group(3));
	    System.out.println();
	}
	
	<span style="font-style: italic">// Or use the Streams API:</span>

	regex.matcher(text).results().forEach(matchResult -&gt; {
	    System.out.println(<span style="font-style: italic">&quot;full: &quot;</span> + matchResult.group());
	    System.out.println(<span style="font-style: italic">&quot;year: &quot;</span> + matchResult.group(1));
	    System.out.println(<span style="font-style: italic">&quot;month: &quot;</span> + matchResult.group(2));
	    System.out.println(<span style="font-style: italic">&quot;day: &quot;</span> + matchResult.group(3));
	    System.out.println();
	});
